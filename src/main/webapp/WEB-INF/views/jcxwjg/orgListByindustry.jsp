			 ...
			 <select style="width:153px">
               ...
               <div id="container" style="min-width:400px;height:400px;margin:0 auto;margin-top:5px"></div>
                <table width="1000" height="69" border="1" align="center" cellpadding="0" cellspacing="1" bgcolor="#868686" style="text-align:center;margin-top:30px;">
				   ...
				   <c:forEach items="${orgList1}" var="org1">
				       <td width="44" bgcolor="#FFFFFF" nowrap style="padding:2px">${org1[1]}</td>
				    </c:forEach>
				   ...
				   <!--  <td width="43" bgcolor="#FFFFFF" nowrap style="padding:2px">广州市</td>
				    ...
				    <td width="46" bgcolor="#FFFFFF" nowrap style="padding:2px">外省来粤</td> -->
				  </tr>
				 
				  <tr>
				  
				    <td width="44"  bgcolor="#FFFFFF" nowrap style="padding:2px">全民所有制</td>
				     <c:forEach items="${orgList1}" var="org1">
					  <td width="44"  bgcolor="#FFFFFF">${org1[2]}</td>
				     </c:forEach>
				  </tr>
		
				  <tr >
				    <td bgcolor="#FFFFFF" nowrap style="padding:2px">集体所有制</td>
				      <c:forEach items="${orgList2}" var="org2">
					     <td bgcolor="#FFFFFF">${org2[2]}</td>
				      </c:forEach>
				  </tr>
		       		   
				  <tr>
				    <td bgcolor="#FFFFFF" nowrap style="padding:2px">有限责任制</td>
					<c:forEach items="${orgList3}" var="org3">
					   <td bgcolor="#FFFFFF">${org3[2]}</td>
				    </c:forEach>
				  </tr>
	
				   <tr>
				    <td bgcolor="#FFFFFF" nowrap style="padding:2px">股份合作制</td>
				      <c:forEach items="${orgList4}" var="org4">
					      <td bgcolor="#FFFFFF">${org4[2]}</td>
				      </c:forEach>
				  </tr>
