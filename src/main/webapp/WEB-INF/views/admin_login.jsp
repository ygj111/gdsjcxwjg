...
<input type="hidden" name="rememberMe" id="rememberMe" >
	<div class="login">
<div class="lbt">
广东省建设工程质量检测管理及检测行为监管平台
</div>
<div class="ldl">
<ul class="shuru">
<li>
<input type="text" name="admin" placeholder="用户名" id="username" name="username"  autofocus/>
...
<li>
<input type="text" name="text" placeholder="验证码" class="yzm"/>
<img src="../img/login/yzm.png" class="yzmimg">
</li>
</ul>
<div class="jizhu">
<input name="jizhu" type="checkbox" value="" />
 <label> 记住密码</label>
<label class="jzr">忘记密码</label> 
</div>

<button type="submit" class="lbtn">登录</button>
<div class="lbtn">登&nbsp;&nbsp;录</div>
</div>
<div class="lfooter">
技术支持单位：广州粤建三和软件股份有限公司
</div>
